  ...
  class BlogPaginationGenerator < Generator
    ...
    def generate(site)
      ...
      (2..total_pages).each do |page_num|
        ...
        pagination_page.data['include_header'] = 'writing_header.html'
        pagination_page.data['page_num'] = page_num
        pagination_page.data['include_comments'] = { 'count' => true }
        
        # Use the same content as blog/index.html
        pagination_page.content = File.read(File.join(site.source, 'blog', 'index.html')).split('---')[2]
